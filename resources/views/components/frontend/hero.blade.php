<section
  class="relative overflow-hidden py-14 md:py-20 md:pb-24 bg-[linear-gradient(160deg,#0f2347_0%,#1a3a6b_55%,#1e4a8a_100%)]"
  ...
  <div class="relative w-full max-w-[1200px] mx-auto px-4 md:px-6 xl:px-8">
    <div class="md:grid md:grid-cols-[1fr_auto] md:gap-12 md:items-center">
      <div>
        <div
          class="animate-fade-down inline-flex items-center gap-2 mb-5 px-3.5 py-1.5 rounded-full bg-orange/15 border border-orange/40 text-sm font-semibold tracking-wide text-[#ffa070]">
          <i class="bi bi-patch-check-fill text-orange" aria-hidden="true"></i>
          ประสบการณ์กว่า 20 ปี · ไว้ใจได้
        </div>
        <h1
          class="animate-fade-up [animation-delay:.1s] font-display font-bold text-white leading-[1.1] mb-4 text-[clamp(2rem,7vw,3.8rem)]"
          id="hero-title">
          ผู้เชี่ยวชาญ
          <span class="block text-orange pt-4">ซ่อมเครื่องดูดฝุ่น<br>อุตสาหกรรม</span>
        </h1>
        <p
          class="animate-fade-up [animation-delay:.2s] max-w-[520px] mb-8 leading-[1.7] text-white/[.78] text-[clamp(1rem,2.5vw,1.15rem)]">
        ...
        <div class="animate-fade-up [animation-delay:.4s] grid grid-cols-3 gap-3 mt-12" aria-label="สถิติผลงาน">
          ...
          <div class="text-center py-4 px-2 rounded-xl bg-white/[.07] border border-white/10 backdrop-blur-sm">
            <span
              class="block font-display font-bold text-orange leading-none text-[clamp(1.5rem,5vw,2rem)]">500+</span>
      ...
      <div class="hidden md:flex justify-end" aria-hidden="true">
        <div
          class="relative overflow-hidden w-80 h-[380px] rounded-[20px] bg-white/5 border border-white/10 flex flex-col items-center justify-center gap-4">
          <div class="absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,rgba(242,101,34,.15),transparent_70%)]">
          </div>
