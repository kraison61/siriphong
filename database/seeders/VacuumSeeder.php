...
class VacuumSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ([
            ...
            ['key' => 'site_phone',       'value' => '081-792-8148'],
            ['key' => 'site_line',        'value' => 'https://line.me/ti/p/Kqsti_kwU9'],
            ['key' => 'site_address',     'value' => '69 ซอยสุขสวัสดิ์ 26 แยก 10-5 ราษร์บูรณะ กรุงเทพฯ 10140'],
        ...
        $services = [
            [
                ...
                'image'             => 'service/ametek-vacuum-motor.webp',
                'price'             => 0,
                'sale_price'        => null,
                'is_active'         => true,
                'is_featured'       => true,
            ...
            [
                ...
                'image'             => 'service/hepa-filter.webp',
                'price'             => 800,
                'sale_price'        => null,
                'is_active'         => true,
                'is_featured'       => false,
            ...
            [
                ...
                'image'             => 'service/electrolux-mainboard.webp',
                'price'             => 0,
                'sale_price'        => null,
                'is_active'         => true,
                'is_featured'       => false,
        ...
        $products = [
            [
                ...
                'specs'             => json_encode([
                    ...
                    ['name' => 'ความจุถัง', 'value' => '15', 'unitText' => 'L'],
                    ['name' => 'ระบบกรอง', 'value' => 'HEPA'],
            ...
            [
                ...
                'specs'             => json_encode([
                    ['name' => 'กำลังไฟ', 'value' => '2760', 'unitText' => 'W'],
                    ['name' => 'ความจุถัง', 'value' => '65', 'unitText' => 'L'],
                    ['name' => 'ระบบกรอง', 'value' => 'HEPA H13'],
                    ['name' => 'น้ำหนัก', 'value' => '28', 'unitText' => 'kg'],
                ]),
            ],
            [
                'category_id'       => $categories['industrial-vacuum'],
                ...
                'specs'             => json_encode([
                    ['name' => 'กำลังไฟ', 'value' => '1050', 'unitText' => 'W'],
                    ['name' => 'ความจุถัง', 'value' => '32', 'unitText' => 'L'],
                    ['name' => 'ระบบกรอง', 'value' => 'HEPA'],
                    ['name' => 'น้ำหนัก', 'value' => '9.2', 'unitText' => 'kg'],
                ]),
            ],
            [
